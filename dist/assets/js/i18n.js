...
window.CRN_I18N = (() => {
  ...
  const dictionaries = {
    "zh-CN": {
      ...
      "hero.schematicAria": "示意性链上关系图；4# 为外部区块浏览器链接，不代表钱包归属认定。",
      "hero.networkTitle": "链上关系示意图",
      "hero.networkDesc": "仅为示意图；4# 链接由提交材料提供，不代表钱包归属认定。公开链上数据仍待核验。",
      "hero.estimated": "估算",
      "hero.wallet": "4#",
      "hero.walletLink": "在 Etherscan 中打开钱包 4#",
      "hero.flow": "流向",
      "hero.destination": "去向",
      "hero.noRecords": "来源标注的钱包链接 · 等待核验",
  ...
  const english = {
    ...
    "hero.file": "CASE FILE", "hero.title": "INVESTOR<br><span>RECOVERY</span><br>NETWORK", "hero.estimate": "ESTIMATED FIGURE · PUBLIC SOURCE PENDING", "hero.description": "A public network for case materials, verifiable on-chain evidence, and investor information submission.", "hero.explore": "EXPLORE CASE", "hero.schematic": "ON-CHAIN SCHEMATIC", "hero.schematicAria": "Illustrative on-chain network schematic; 4# is an external explorer link and does not establish wallet ownership.", "hero.networkTitle": "On-chain network schematic", "hero.networkDesc": "An illustrative network only. The 4# link was supplied in submitted materials and does not establish wallet ownership. Public chain data is pending verification.", "hero.estimated": "ESTIMATED", "hero.wallet": "4#", "hero.walletLink": "Open wallet 4# in Etherscan", "hero.flow": "FLOW", "hero.destination": "DEST.", "hero.noRecords": "SOURCE-LABELLED WALLET LINK · VERIFICATION PENDING", "hero.dataPending": "DATA PENDING", "hero.statusAria": "Case status overview", "hero.scroll": "SCROLL TO INVESTIGATE",
