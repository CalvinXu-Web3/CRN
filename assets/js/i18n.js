...
window.CRN_I18N = (() => {
  ...
  const dictionaries = {
    "zh-CN": {
      ...
      "hero.schematicAria": "示意性链上关系图。暂无可用链上数据。",
      "hero.networkTitle": "链上关系示意图",
      "hero.networkDesc": "仅为示意图；公开链上数据仍待核验。",
      "hero.estimated": "估算",
      "hero.wallet": "钱包",
      "hero.flow": "流向",
      "hero.destination": "去向",
      "hero.noRecords": "尚未发布公开链上记录",
      ...
      "onchain.noTransactionsDescription": "在独立核验前，TXID、钱包地址、链与浏览器链接将不会公开。",
